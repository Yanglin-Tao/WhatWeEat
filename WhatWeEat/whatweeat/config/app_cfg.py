# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in WhatWeEat.
...
import whatweeat
from whatweeat import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': whatweeat.model,
    'DBSession': whatweeat.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "fd3037da-ecdb-4a45-82a3-ac572eadaccb",
